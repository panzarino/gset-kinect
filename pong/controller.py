...
class Controller(object):
	...
	def start(self):
		...
		self.game.render()
		text1_pos = center_text(self.start_font, "Welcome to Push-up Pong", self.game.screensize[0], self.game.screensize[1])
		text2_pos = center_text(self.start_font, "You have 10 seconds until the game starts!", self.game.screensize[0], self.game.screensize[1])
		text3_pos = center_text(self.start_font, "Get Ready!", self.game.screensize[0], self.game.screensize[1])
		text1_pos = (text1_pos[0], text1_pos[1]-self.game.screensize[0]/8)
		text3_pos = (text3_pos[0], text3_pos[1]+self.game.screensize[0]/8)
		text1 = Text(self.game.screen, self.start_font, "Welcome to Push-up Pong", self.color['left'], text1_pos)
		text1.draw()
		text2 = Text(self.game.screen, self.start_font, "You have 10 seconds until the game starts!", self.color['text'], text2_pos)
		text2.draw()
		text3 = Text(self.game.screen, self.start_font, "Get Ready!", self.color['right'], text3_pos)
		text3.draw()
		self.game.render()
		self.game.delay(8)
		# draw all objects
	...
	def end(self):
		...
		text1_pos = center_text(self.end_font, text, self.game.screensize[0], self.game.screensize[1])
		text2_pos = center_text(self.end_font, score, self.game.screensize[0], self.game.screensize[1])
		text1_pos = (text1_pos[0], text1_pos[1]-self.game.screensize[0]/16)
		text2_pos = (text2_pos[0], text2_pos[1]+self.game.screensize[0]/16)
		text1 = Text(self.game.screen, self.end_font, text, self.color['win'], text1_pos)
		text1.draw()
		text2 = Text(self.game.screen, self.end_font, score, self.color['text'], text2_pos)
		text2.draw()
		self.game.render()
		self.game.delay(10)
		self.game.quit()
