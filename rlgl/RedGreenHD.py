...
skeleton_input = raw_input(Would you like to have a skeleton displayedn(y, n))
while(draw_skeleton == None)
    if skeleton_input == y
        ...
        skeleton_input = raw_input(Enter a valid valuen(y, n))
body_parts = raw_input(Would you like to work your upper body, lower body, or bothn(u, l, b))
while not (arms or legs)
    if body_parts == b
        ...
        body_parts = raw_input(Please enter a valid responsen(u, l, b))
...
# recipe to get address of surface httparchives.seul.orgpygameusersApr-2008msg00218.html
...
def draw_score()
    ...
    p1 = center(myfont, str(num_players) + -P, 1024, 0, 1280, 120)
    screen.unlock()
    try
...
posA = center(myfont2, SCORE, 0, 0, 1280, 512)
posB = center(myfont2, str(int(score)), 0, 240, 6280, 1024)
pos2A = center(myfont2, NET SCORE, 0, 0, 1280, 240)
pos2B = center(myfont2, str(int(net_score)), 0, 640, 1280, 512)
